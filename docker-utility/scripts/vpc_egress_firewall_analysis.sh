...
provide_troubleshooting() {
    ...
    echo "   gcloud run jobs execute utility-job \\"
    echo "     --command 'nslookup storage.googleapis.com' \\"
    echo "     --region us-central1"
    echo
    ...
    echo "     --filter='direction=EGRESS' \\"
    echo "     --format='table(name,network,direction,priority,sourceRanges,targetTags)'"
    echo
